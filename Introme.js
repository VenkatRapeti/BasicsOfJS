...
//innerHTML : it rendenders data includes html elements proceess it
//innerText : it not process html tags and not show hidden data
//textContent : data renders same as vs code and shows hidden one also or everything in vs 

function inner() {
    var elemnt = document.getElementById("one");
    elemnt.innerHTML += "<h1>Shubham</h1>";
}
...
//for all one = querySelector(.class,#id,div) gives first one

// but select all tags through querySelectorAll(p)
...
// in some one element pass the test it will become true
// in every every element pass the test then only it will become true

var arr1 = [1, 3, 5, 7, 8, 9, 23, 42];
arr1.some(item => item % 2 == 0);
//true

var arr1 = [1, 3, 5, 7, 8, 9, 23, 42];
arr1.every(item => item % 2 == 0);
//false
...
//    > always use constructor as name
...
// ES - EcmaScript - ES is a community for JS which sets the Rules/Regulations 
//that we need to follow while working with JS 
...
var anarr = [99, 98, 97, 95, 87, 76, 68, 56, 45, 35]
var [first, second, third, ...listToImprove] = anarr

// first 99 
// second 98
//third 97
//listToImprove (7) [95, 87, 76, 68, 56, 45, 35]
